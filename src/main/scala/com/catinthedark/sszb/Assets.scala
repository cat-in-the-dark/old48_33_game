...
object Assets {
  ...
  object Textures {
    ...
    val t1 = new Texture(Gdx.files.internal("textures/t1_eng.png"))
    val t2 = new Texture(Gdx.files.internal("textures/t2_eng.png"))
    val t3 = new Texture(Gdx.files.internal("textures/t3_eng.png"))
